...
terraform plan -var "tag=stress"  -var "cluster_id=04ea9a1e-b0cb-442d-8db2-90717f8ea199"  \
...
-var "ssh_fingerprint=b1:cd:87:e6:e9:79:4a:eb:05:a0:83:65:18:18:6e:a5" -out newplan.txt
